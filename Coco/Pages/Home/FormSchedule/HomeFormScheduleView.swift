...
final class HomeFormScheduleView: UIView {
    ...
    lazy var tableView: UITableView = {
        ...
        table.backgroundColor = Token.grayscale10
    ...
    private func setupView() {
        ...
        tableView.layout {
            $0.top(to: safeAreaLayoutGuide.topAnchor)
            $0.leading(to: leadingAnchor)
            $0.trailing(to: trailingAnchor)
            $0.bottom(to: bottomContainerView.topAnchor)
        }
    ...
    func addBottomInputView(from view: UIView) {
